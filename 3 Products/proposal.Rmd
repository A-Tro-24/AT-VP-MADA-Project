...
This data set was obtained directly from the CDC's online data catalog at data.cdc.gov. Data: <https://data.cdc.gov/NCHS/Provisional-COVID-19-Deaths-by-Sex-and-Age/9bhg-hcku>
...
```{r}
#path to raw data
data_location <- here::here("1 Data","Raw","Provisional_COVID-19_Deaths_by_Sex_and_Age.csv")
...
Data/question background will be placed here.
